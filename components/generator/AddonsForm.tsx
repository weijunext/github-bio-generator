        ...
        <div key={addon.name} className="inline-flex items-center">
          ...
          >
            <input
              ...
              className="generator-addons-checkbox before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-blue-gray-200 transition-all checked:border-amber-500 checked:bg-amber-500 checked:before:bg-amber-500 hover:before:opacity-10"
            />
